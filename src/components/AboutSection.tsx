      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="lg:pl-8 mt-12 lg:mt-0">
            ...
            <Link href="/about/team" className="bg-brand-red hover:bg-brand-dark text-white px-6 py-2.5 rounded font-bold uppercase tracking-wider transition-all shadow-md hover:shadow-lg inline-flex items-center text-sm w-fit">
