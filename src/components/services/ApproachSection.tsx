...
export default function ApproachSection() {
  return (
    <div className="bg-[#cc3939] rounded-t-3xl sm:rounded-t-[3rem] shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.15)] mx-4 sm:mx-8 py-8 sm:py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-8">
          ...
          <h2 className="text-[35px] font-bold text-white mb-0">
            How We Care For You
          </h2>
        </div>
