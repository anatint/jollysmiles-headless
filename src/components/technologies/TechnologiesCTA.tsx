      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-red-50 rounded-2xl p-6 md:p-10 flex flex-col lg:flex-row items-center justify-between gap-8 border border-red-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
            ...
            <Link href={pathname === '/contact' ? '#contact-form' : '/contact#contact-form'} className="bg-white border-2 border-brand-red text-brand-red hover:bg-red-50 px-6 py-2.5 rounded font-bold uppercase tracking-wider transition-all duration-300 shadow-sm flex items-center justify-center gap-2 text-sm whitespace-nowrap">
