...
export default function Footer() {
  return (
    <footer className="bg-brand-dark text-white pb-8 py-[30px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/20 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-red-100 py-[30px]">
