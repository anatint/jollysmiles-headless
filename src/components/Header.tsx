    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <nav className="flex space-x-8 items-center">
              ...
              <Link href="/contact" className={`font-medium hover:text-brand-red transition ${pathname === '/contact' ? 'text-brand-red border-b-2 border-brand-red pb-1' : 'text-gray-700'}`}>Contact Us</Link>
            </nav>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-100 px-2 pt-2 pb-3 space-y-1 shadow-lg absolute w-full left-0">
          ...
          <Link href="/contact" className="block px-3 py-2 text-gray-700 font-medium hover:text-brand-red">Contact Us</Link>
          <button 
            onClick={() => {
